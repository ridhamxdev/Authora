                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="mt-8 space-y-6">
                        ...
                        <p className="text-center text-sm text-gray-400">
                            ...
                            <Link href="/register" className="font-semibold text-white hover:text-gray-300 transition-colors">
                                Sign up
                            </Link>
                        </p>
                    </div>
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <p className="text-lg text-gray-400 leading-relaxed max-w-md mx-auto">
                                Experience commerce at the speed of thought. Secure, scalable, and brutally efficient.
                            </p>
                        </div>
